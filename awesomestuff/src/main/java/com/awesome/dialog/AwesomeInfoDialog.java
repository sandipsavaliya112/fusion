 ...
 */
public class AwesomeInfoDialog extends AwesomeBase<AwesomeInfoDialog> {
    ...
    public AwesomeInfoDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public AwesomeInfoDialog setNotShowAgainOptionEnabled(int dialogId) {
    ...
    public AwesomeInfoDialog setNotShowAgainOptionChecked(boolean defaultChecked) {
        cbDontShowAgain.setChecked(defaultChecked);
        return this;
    }

    public AwesomeInfoDialog setConfirmButtonText(@StringRes int text) {
        return setConfirmButtonText(string(text));
    }

    public AwesomeInfoDialog setConfirmButtonText(String text) {
        confirmButton.setText(text);
        return this;
    }

    public AwesomeInfoDialog setConfirmButtonColor(int color) {
