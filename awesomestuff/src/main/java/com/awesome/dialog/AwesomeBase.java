...
public abstract class AwesomeBase<T extends AwesomeBase> {
    ...
    public AwesomeBase(Context context) {
        init(new AlertDialog.Builder(context));
    }

    public AwesomeBase(Context context, int theme) {
     ...
     * help you in this.
     */
    public T setInstanceStateHandler(int id, AwesomeSaveStateHandler handler) {
    ...
    protected class ClickListenerDecorator implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (clickListener != null) {
                if (clickListener instanceof AwesomeCompatDialog.DialogOnClickListenerAdapter) {
                    AwesomeCompatDialog.DialogOnClickListenerAdapter listener =
                            (AwesomeCompatDialog.DialogOnClickListenerAdapter) clickListener;
