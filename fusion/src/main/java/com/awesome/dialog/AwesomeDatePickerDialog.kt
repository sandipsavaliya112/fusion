...
class AwesomeDatePickerDialog : AwesomeBase<AwesomeDatePickerDialog> {
    ...
    fun setView(@LayoutRes layout: Int): AwesomeDatePickerDialog {
    ...
    fun setView(customView: View): AwesomeDatePickerDialog {
    ...
    fun configureView(configurator: ViewConfigurator): AwesomeDatePickerDialog {
        if (addedView == null) {
    ...
    fun setListener(viewId: Int, listener: View.OnClickListener): AwesomeDatePickerDialog {
        return setListener(viewId, false, listener)
    }

    fun setListener(viewId: Int, dismissOnClick: Boolean, listener: View.OnClickListener): AwesomeDatePickerDialog {
        if (addedView == null) {
            throw IllegalStateException(string(R.string.ex_msg_dialog_view_not_set))
        }
